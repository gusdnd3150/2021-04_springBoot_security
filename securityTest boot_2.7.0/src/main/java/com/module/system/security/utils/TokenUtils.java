package com.module.system.security.utils;
...
public class TokenUtils {
    ...
    public static boolean isValidToken(String token) {
        try {
            ...
            logger.info("isValidToken logic start");
    ...
    public static Authentication getAuthentication(String token) {
        ...
        // vo 치완을 사용했으나 map 객체를 사용하니 에러 발생 임시로 사용
		LinkedHashMap<String, Object> principal  = (LinkedHashMap<String, Object>) claims.get("userVo");
        UserMap<String, Object> userMap = new UserMap<>();
        for (Map.Entry<String, Object> entry : principal.entrySet()) {
        	userMap.put(entry.getKey() , entry.getValue());
        }
        return new UsernamePasswordAuthenticationToken(userMap, token, authorities);
    }
